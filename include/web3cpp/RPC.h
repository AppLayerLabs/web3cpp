...
namespace RPC {
  ...
  json eth_getBalance(std::string address, std::string defaultBlock);
  json eth_getBalance(std::string address, BigNumber defaultBlock);
  json eth_getStorageAt(std::string address, std::string position, std::string defaultBlock);
  json eth_getStorageAt(std::string address, std::string position, BigNumber defaultBlock);
  json eth_getTransactionCount(std::string address, std::string defaultBlock);
  ...
  json eth_getCode(std::string address, std::string defaultBlock);

...
void Tests::loadAndTestContract() {
  ...
  std::string const testMuiltipleByteArrayExpected = "";
  ...
  //std::string testMuiltipleByteArray = ArrayTest("testMuiltipleByteArray",
  //  json::array({
  //    json::array({
  //      "0xaaaa",
  //      "0xbbbb"
  ...
  //, error);
//
  //std::cout << testMuiltipleByteArray << std::endl;
